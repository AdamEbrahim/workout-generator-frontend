      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
                <MenuItem key={'Generator'} onClick={handleCloseNavMenu}>
                  <Link style={{color: 'black', textDecoration: 'none'}} to='/'>Generator</Link>
                </MenuItem>
                <MenuItem key={'Exercises'} onClick={handleCloseNavMenu}>
                  <Link style={{color: 'black', textDecoration: 'none'}} to='/exercises'>Exercises</Link>
                </MenuItem>
            </Menu>
          </Box>
          ...
          <Box sx={{ flexGrow: 1, justifyContent: 'center', columnGap: '4%', display: { xs: 'none', md: 'flex' }}}>
              ...
              >
                <Link style={{color: 'white', fontWeight: 'bold', textDecoration: 'none'}} to='/'>Generator</Link>
              </Button>
              ...
              <Button
                ...
                sx={{ my: 2, color: 'white', display: 'block' }}
              >
                <Link style={{color: 'white', fontWeight: 'bold', textDecoration: 'none'}} to='/exercises'>Exercises</Link>
              </Button>
          </Box>
